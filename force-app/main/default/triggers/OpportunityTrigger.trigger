// ------- 3/20/2023 -------------------
// -------- TRIGGER CHANGE STAGE NAME -----------

// ---- Gettin old value & new value ------------
...
/**
Status change requirement can be done 
both before and after update event since 
we already have access to the opportunity Id ,
we chose to put it in after since we already have 
some codes in before update
 */